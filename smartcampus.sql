...
-- Records of card
-- ----------------------------
INSERT INTO `card` VALUES (1, '1', '1', '1', 1, '1');
...
CREATE TABLE `goods`  (
  ...
  `g_state` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品状态 1上架 0下架 -1缺货',
...
-- ----------------------------
INSERT INTO `shop_info` VALUES ('1', '1', '1', '1');
...
CREATE TABLE `user`  (
  ...
  `shop_type` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '0普通用户 1商家',
  PRIMARY KEY (`uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
