    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-gbtag">
            <ul class="nav navbar-nav">
                <li><a href="<%=basePath%>/goods/toListPage.do">我的的商品</a></li>
                <li class="dropdown">
            ...
            <form class="navbar-form navbar-left" role="search" action="<%=basePath%>/goods/findByPage.do" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="商品名称" name="g_name" />
                </div>
                <button type="submit" class="btn btn-default" name="g_name">搜索</button>
            </form>
